...
<pre><code>apt update && apt install -y screen bsdextrautils util-linux coreutils wget curl dos2unix && wget -q https://raw.githubusercontent.com/PeyxDev/esce/main/setup.sh && chmod +x setup.sh && ./setup.sh
</code></pre>
