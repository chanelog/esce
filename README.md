...
<pre><code>apt install -y screen dos2unix && wget -q https://raw.githubusercontent.com/PeyxDev/esce/main/setup.sh && chmod +x setup.sh && dos2unix setup.sh && ./setup.sh
</code></pre>

---

### INSTALL SCRIPT DEBIAN
<pre><code>apt update && apt install -y screen bsdextrautils util-linux coreutils wget curl dos2unix && wget -q https://raw.githubusercontent.com/PeyxDev/esce/main/setup.sh && chmod +x setup.sh && dos2unix setup.sh && ./setup.sh
</code></pre>
