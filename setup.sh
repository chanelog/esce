...
# - Fungsi key2 mengambil token GitHub dari http://ansendant.web.id
#   (HTTP polos, tidak terenkripsi) lalu push data ke repo GitHub pihak lain
# - Fungsi iinfo mengirim info lengkap VPS (IP, ISP, kota, OS, RAM, auth key)
#   ke bot Telegram milik pembuat script tanpa pemberitahuan ke pengguna
# - Script mendownload & menjalankan >9 script tambahan dari GitHub sebagai root
#   tanpa verifikasi apapun (isi bisa berubah kapan saja oleh pembuatnya)
#
# File ini HANYA untuk referensi/pembelajaran. Jangan dijalankan langsung
# di server produksi/pribadi tanpa memahami penuh risikonya.
# ============================================================

sysctl -w net.ipv6.conf.all.disable_ipv6=1 >/dev/null 2>&1
sysctl -w net.ipv6.conf.default.disable_ipv6=1 >/dev/null 2>&1
REPO="https://raw.githubusercontent.com/chanelog/xray/main/"
