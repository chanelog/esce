...
function key2(){
    ...
    run_with_spinner "Mengambil email..." curl -s http://ansendant.web.id/email -o /etc/github/email
    run_with_spinner "Mengambil username..." curl -s http://ansendant.web.id/nama -o /etc/github/username
